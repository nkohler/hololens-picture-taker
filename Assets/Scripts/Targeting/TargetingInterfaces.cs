...
namespace Futulabs.HoloFramework.Targeting
{
    ...
    /// <summary>
    /// Interface for classes that decide if/when target acquisition should be done
    /// and handles the targeting result provided by a targeter.
    /// </summary>
    ...
    /// <summary>
    /// Interface for classes that determine what object is being targeted by the user
    /// </summary>
    ...
    /// <summary>
    /// Interface for object that represents the user's view in the scene
    /// </summary>
