...
namespace Futulabs.HoloFramework.SpatialMapping
{
    ...
    /// <summary>
    /// Interface for classes that handle the generation of spatial mapping
    /// meshes
    /// </summary>
    ...
    /// <summary>
    /// Interface for classes representing a mapped surface
    /// </summary>
    ...
    /// <summary>
    /// Interface for classes that dynamically create new spatial surfaces
    /// </summary>
